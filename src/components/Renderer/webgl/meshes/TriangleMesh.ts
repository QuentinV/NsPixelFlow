...
import { TriangleMeshSettings } from '../../../../api/projects';

export class TriangleMesh extends BaseMesh<TriangleMeshSettings> {
    constructor(props: MeshProps<TriangleMeshSettings>) {
        super(props);
    }
    ...
    create() {
        ...
        const rectangle1 = new THREE.Points(
            new THREE.BoxGeometry(7, 1, 1, widthSeg, heightSeg, depthSeg),
            this.material
        );
        const rectangle2 = new THREE.Points(
            new THREE.BoxGeometry(7, 1, 1, widthSeg, heightSeg, depthSeg),
            this.material
        );
        const rectangle3 = new THREE.Points(
            new THREE.BoxGeometry(7, 1, 1, widthSeg, heightSeg, depthSeg),
            this.material
        );
